...
public sealed class TrayIcon : IDisposable
{
    ...
    /// <summary>The registered global hotkey was pressed (F3 — opens the picker from anywhere).</summary>
    ...
    /// <summary>
    /// Registers a system-wide hotkey on the tray's message window (F3). Returns false when the
